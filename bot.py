...
# -*- coding: utf-8 -*-
"""
POETRA AI Signal Bot v4 — 24/7 Telegram.
Fibonacci golden zone + arah tren + UT Bot(sensitif) + EMA/RSI/MACD.
Hanya kirim REKOMENDASI ENTRY bila YAKIN (confidence >= MIN). Bahasa jelas & rapi.
...
def fmt_symbol(symbol, tf_res):
    ...
    if best:
        ...
        L.append("Saran: tunggu harga masuk golden zone Fibonacci + konfirmasi tren. Jangan paksa entry.")
    L.append("━"*12)
